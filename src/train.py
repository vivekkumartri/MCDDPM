...
def train(cfg: DictConfig) -> Optional[float]: 
    ...
    for fold in range(start_fold,end_fold): # iterate over folds 
        ...
        #print(model)
        #print(os.getcwd())
        #checkpoint = torch.load("/home/mcddpm/logs/runs/MCDDPM_2D_patched_l2_loss_without_deconv/DDPM_patched_2D_IXI_MCDDPM_2D_patched_l2_loss_without_deconv__2024-04-14_10-37-03/checkpoints/epoch-216_step-83544_loss-0.00_fold-1.ckpt")
    ...
    # Evaluate model on test set, using the best or last model from each trained fold 
        ...
        if cfg.get("test_after_training"): # and not 'simclr' in  cfg.model._target_.lower():
            ...
            for set in cfg.datamodule.cfg.testsets :
                ...
                ckpt_path="/home/mcddpm/logs/runs/MCDDPM_2D_patched_l2_loss_without_deconv/DDPM_patched_2D_IXI_MCDDPM_2D_patched_l2_loss_without_deconv__2024-04-15_10-42-08/checkpoints/epoch-21_step-8469_loss-0.00_fold-1.ckpt"#"/home/mcddpm/logs/runs/MCDDPM_2D_patched_l2_loss+1_times_deconv_loss/DDPM_patched_2D_IXI_MCDDPM_2D_patched_l2_loss+1_times_deconv_loss__2024-04-13_02-54-01/checkpoints/epoch-299_step-115499_loss-0.00_fold-1.ckpt" #cfg.get('ckpt_path',None) #"/home/mcddpm/logs/runs/MCDDPM_2D_patched_EL_loss+Deconv_Loss/DDPM_patched_2D_IXI_MCDDPM_2D_patched_EL_loss+Deconv_Loss__2024-04-08_02-47-11/checkpoints/epoch-190_step-73534_loss-0.00_fold-1.ckpt" #"/home/mcddpm/logs/runs/MCDDPM_2D_patched/DDPM_patched_2D_IXI_MCDDPM_2D_patched__2024-04-06_10-52-37/checkpoints/epoch-203_step-78539_loss-0.00_fold-1.ckpt" #"/scratch/mcddpm/patched-Diffusion-Models-UAD/logs/runs/MCDDPM_2D_patched/DDPM_patched_2D_IXI_MCDDPM_2D_patched__2024-04-03_18-24-01/checkpoints/epoch-295_step-113959_loss-0.00_fold-1.ckpt"   #"/scratch/mcddpm/patched-Diffusion-Models-UAD/logs/runs/MCDDPM_2D/DDPM_2D_IXI_MCDDPM_2D__2024-04-02_17-41-41/checkpoints/epoch-292_step-112804_loss-0.00_fold-1.ckpt" #cfg.get('ckpt_path',None) #"/scratch/mcddpm/patched-Diffusion-Models-UAD/logs/runs/DDPM_2D_patched/dice53.29/checkpoints/epoch-147_step-56979_loss-0.00_fold-1.ckpt" #cfg.get('ckpt_path',None) #
